import InstanceTypesDropdown from 'rjsf/fields/InstanceTypesDropdown'

export const InstanceTypesDropdownPreview = ({
  value,
  formData,
  onChange,
  uiSchema,
...
export default InstanceTypesDropdownPreview
